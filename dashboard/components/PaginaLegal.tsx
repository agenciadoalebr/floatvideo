    ...
    <div className="min-h-screen bg-white">
      <header className="border-b border-neutral-200">
        <div className="mx-auto flex max-w-3xl items-center justify-between px-4 py-3">
          ...
          <Link href="/" className="text-sm text-neutral-600 hover:text-brand-blue">
            Voltar ao site
          </Link>
        </div>
      </header>
      ...
      <main className="mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="mt-8 space-y-8 text-sm leading-relaxed text-neutral-700 [&_a]:text-brand-blue [&_a:hover]:underline [&_h2]:text-lg [&_h2]:font-semibold [&_h2]:text-brand-ink [&_li]:ml-4 [&_li]:list-disc [&_p]:mt-2 [&_ul]:mt-2 [&_ul]:space-y-1">
          {children}
        </div>
      </main>

      <footer className="mx-auto flex max-w-3xl flex-col gap-2 px-4 py-8 text-xs text-neutral-500 sm:flex-row sm:justify-between">
